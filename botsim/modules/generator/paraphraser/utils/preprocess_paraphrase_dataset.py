...
def process_mscoco_paralex_qqp_hrq_vae_jsonl(path):
    ...
    for s in ['train', 'dev', 'test']:
        ...
        entries = set()
        with open(path+'/{}.jsonl'.format(s), 'r') as json_file:
...
if __name__ == "__main__":
    ...
    # tapaco
    #cosine_low = 0.0, cosine_high = 0.8, edit_high = 70, diff_ratio = 1.0, min_len = 5
    ...
    # tgt_dir='../paraphraser/data/processed_datasets/mrpc'
    # os.makedirs(tgt_dir, exist_ok=True)
    # process_mrpc(tgt_dir+'/mrpc.txt')
